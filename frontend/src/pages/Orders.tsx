        ...
        <div className='max-w-7xl mx-auto px-6 relative z-10'>
          ...
          >
            ...
            >
              ...
              <motion.div className='w-8 h-0.5 bg-stone-300 mx-auto mt-2 group-hover:bg-black transition-colors duration-500' />
            </motion.div>
            ...
            >
              ...
              <motion.div className='w-8 h-0.5 bg-stone-300 mx-auto mt-2 group-hover:bg-stone-700 transition-colors duration-500' />
            </motion.div>
                          ...
                          <div className='space-y-6'>
                            {order.attributes.items.map((item, i) => (
                              <motion.div
                                ...
                                transition={{ duration: 0.3 }}
                              >
                                <motion.div className='absolute inset-0 bg-stone-50 opacity-0 group-hover/item:opacity-100 transition-opacity duration-500' />
