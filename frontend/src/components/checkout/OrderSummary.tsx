    ...
    <div className="bg-white border border-stone-200 p-8 sticky top-24">
      ...
      <div className="space-y-4 mb-6">
        <div className="flex justify-between items-center py-2 border-b border-stone-100">
          <span className="text-stone-600 font-light">Subtotal ({cartItems.length} {cartItems.length === 1 ? 'item' : 'items'})</span>
        ...
        <div className="flex justify-between items-center py-4 border-t border-stone-300">
          ...
          <span className="text-xl font-light text-stone-900">₦{total.toLocaleString()}</span>
        </div>
      </div>
