      ...
      <div className="bg-white border border-stone-200 p-8 sticky top-24">
        ...
        <div className="space-y-4 mb-6">
          <div className="flex justify-between items-center py-2 border-b border-stone-100">
            ...
            <span className="font-light text-stone-900">₦{total.toLocaleString()}</span>
          </div>
          ...
          <div className="flex justify-between items-center py-4 border-t border-stone-300">
            <span className="text-lg font-light tracking-wide text-stone-900 uppercase">Total</span>
            <motion.span
        ...
        <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.98 }}>
          <a href="/checkout" className="block w-full relative group overflow-hidden">
            <motion.div
        ...
        <motion.div className="mt-4 text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8, duration: 0.5 }}>
          <a href="/home" className="text-sm font-light tracking-wide text-stone-500 hover:text-stone-900 transition-colors duration-300 uppercase">
            Continue Shopping
          </a>
        </motion.div>
      </div>
