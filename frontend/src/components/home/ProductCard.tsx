...
export default function ProductCard({ product, index, onAdd, onDelete }: ProductCardProps) {
  const imageUrl = product.attributes.images?.data?.[0]?.attributes.url || "/placeholder.png";
