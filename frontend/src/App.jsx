          ...
          <div className="max-w-7xl mx-auto px-6 py-16">
            ...
            >
              ...
              <div className="flex space-x-6">
                <Link to="/privacy" className="text-stone-400 hover:text-white text-sm font-light transition-colors duration-300">
                  Privacy Policy
                </Link>
                <Link to="/terms" className="text-stone-400 hover:text-white text-sm font-light transition-colors duration-300">
                  Terms of Service
                </Link>
                <Link to="/returns" className="text-stone-400 hover:text-white text-sm font-light transition-colors duration-300">
                  Returns
                </Link>
              </div>
            </motion.div>
