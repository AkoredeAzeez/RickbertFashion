                          ...
                          {item.label}
                                          ...
                                          <div className='flex flex-col items-center py-6 space-y-6'>
                                            {navItems.map(item => (
                                              <Link
                                                key={item.to}
                                                to={item.to}
                                                className='font-light tracking-wide text-lg text-stone-900 hover:text-stone-600 transition-colors duration-300 uppercase'
                                                onClick={() => setIsNavOpen(false)}
                                              >
                                                {item.label}
                                              </Link>
                                ...
                                <main className='relative'>
                                  <Routes>
                                    ...
                                    <Route path='/checkout' element={<div className='pt-20'><Checkout /></div>} />
                                    <Route path='/payment-success' element={<div className='pt-20'><PaymentSuccess /></div>} />
                                    <Route path='/upload' element={<div className='pt-20'><Upload /></div>} />
                                    <Route path='/track-orders' element={<div className='pt-20'><TrackOrders /></div>} />
                                  </Routes>
                                </main>
                                {/* Enhanced Footer */}
