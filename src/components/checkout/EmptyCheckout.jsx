...
export default function EmptyCheckout({ onContinue }) {
  return (
    <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
      ...
      >
        <h2 className="text-2xl font-light tracking-wide text-stone-900 mb-4">NO ITEMS TO CHECKOUT</h2>
        <p className="text-stone-600 font-light mb-8">Your cart is empty. Please add items before proceeding to checkout.</p>
        <button
          onClick={onContinue}
